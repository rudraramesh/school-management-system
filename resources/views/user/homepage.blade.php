...
@section('content-section')
 ...
 <!-- banner part start-->
            ...
            <div class="row align-items-sm-center align-items-lg-stretch">
                <div class="col-md-7 col-lg-7">
                    <div class="learning_img">
                        <img src="{{asset('user/img/learning_img.png')}}" alt="">
                    </div>
                </div>
    ...
    <section class="member_counter">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter">99840</span>
                        <h4> All Students</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter">10020</span>
                        <h4>Online Students</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter">89820</span>
    ...
    <section class="special_cource padding_top">
       ...
       @if(Count($coursehome)==0)
       <span style="color:red;">
        {{'sorry no course available'}}
       </span>
         @else
            <div class="row">
                    @foreach($coursehome as $singlecourse)
                <div  class="col-sm-6 col-lg-4">
                    <div class="single_special_cource">
                        <img src="{{asset('admin/courseimage/'.$singlecourse->image)}}" class="special_img" alt="">
                        <div class="special_cource_text">
                            <a href="{{ route('coursedetails',[$singlecourse->id]) }}" class="btn_4">View All Details</a>
                            <h4>Rs.{{$singlecourse->course_price}}.00</h4>
                            <a href="{{ route('coursedetails',[$singlecourse->id]) }}">
                                <h3>{{$singlecourse->course_name}}</h3>
                            </a>
                            <p>{{$singlecourse->course_professor}}</p>
                            <div class="author_info">
                                <div class="author_img">
                                    <img src="{{asset('user/img/author/author_1.png')}}" alt="">
        ...
        <div class="container">
            <div class="row align-items-sm-center align-items-xl-stretch">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="learning_img">
                        <img src="{{asset('user/img/advance_feature_img.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="textimonial_iner owl-carousel">
                        ...
                        <div class="testimonial_slider">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-2 col-sm-4">
                                    <div class="testimonial_slider_img">
                                        <img src="{{asset('user/img/testimonial_img_2.png')}}" alt="#">
                                    </div>
                                </div>
                                <div class="col-xl-4 d-none d-xl-block">
                                    <div class="testimonial_slider_text">
                        ...
                        <div class="testimonial_slider">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-2 col-sm-4">
                                    <div class="testimonial_slider_img">
                                        <img src="{{asset('user/img/testimonial_img_3.png')}}" alt="#">
                                    </div>
                                </div>
                                <div class="col-xl-4 d-none d-xl-block">
                                    <div class="testimonial_slider_text">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            <img src="{{asset('user/img/blog/blog_1.png')}}" class="card-img-top" alt="blog">
                            <div class="card-body">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            <img src="{{asset('user/img/blog/blog_2.png')}}" class="card-img-top" alt="blog">
                            <div class="card-body">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            <img src="{{asset('user/img/blog/blog_3.png')}}" class="card-img-top" alt="blog">
                            <div class="card-body">
                                <a href="#" class="btn_4">Design</a>
                                <a href="blog.html">
