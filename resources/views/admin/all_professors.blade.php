													...
													<div class="card-body ">
														<div class="row">
															<div class="col-md-6 col-sm-6 col-6">
																<div class="btn-group">
																	<a href="{{ route('addprofessor') }}" id="addRow"
																		class="btn btn-info">
																...
																<tbody>
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="{{asset('admin/assets/img/prof/prof1.jpg')}}"
																				alt="">
																		</td>
																		<td>Rajesh</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="{{asset('admin/assets/img/prof/prof10.jpg')}}"
																				alt="">
																		</td>
																		<td>Pooja Patel</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="{{asset('admin/assets/img/prof/prof2.jpg')}}"
																				alt="">
																		</td>
																		<td>Sarah Smith</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="{{asset('admin/assets/img/prof/prof3.jpg')}}"
																				alt="">
																		</td>
																		<td>John Deo</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="{{asset('admin/assets/img/prof/prof4.jpg')}}"
																				alt="">
																		</td>
																		<td>Jay Soni</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="{{asset('admin/assets/img/prof/prof5.jpg')}}"
																				alt="">
																		</td>
																		<td>Jacob Ryan</td>
																		<td class="left">Computer</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="{{asset('admin/assets/img/prof/prof6.jpg')}}"
																				alt="">
																		</td>
																		<td>Megha Trivedi</td>
																		<td class="left">Mathematics</td>
										...
										<div class="row">
												...
												<div class="card card-box">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="{{asset('admin/assets/img/prof/prof10.jpg')}}" class="doctor-pic"
																alt="">
											...
											<div class="col-md-4">
												<div class="card card-box">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="{{asset('admin/assets/img/prof/prof1.jpg')}}" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
											...
											<div class="col-md-4">
												<div class="card card-box">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="{{asset('admin/assets/img/prof/prof2.jpg')}}" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="card card-box">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="{{asset('admin/assets/img/prof/prof3.jpg')}}" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
											...
											<div class="col-md-4">
												<div class="card card-box">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="{{asset('admin/assets/img/prof/prof4.jpg')}}" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="card card-box">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="{{asset('admin/assets/img/prof/prof6.jpg')}}" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
