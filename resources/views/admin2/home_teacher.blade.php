                                        ...
                                        <table class="table display data-table text-nowrap">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('admin2/img/figure/student2.png')}}" alt="student"></td>
                                                    <td>Mark Willy</td>
                                                    <td>Male</td>
                                                    <td>2</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('admin2/img/figure/student3.png')}}" alt="student"></td>
                                                    <td>Jessia Rose</td>
                                                    <td>Female</td>
                                                    <td>1</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('admin2/img/figure/student4.png')}}" alt="student"></td>
                                                    <td>Mark Willy</td>
                                                    <td>Male</td>
                                                    <td>2</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('admin2/img/figure/student5.png')}}" alt="student"></td>
                                                    <td>Jessia Rose</td>
                                                    <td>Female</td>
                                                    <td>1</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('admin2/img/figure/student6.png')}}" alt="student"></td>
                                                    <td>Mark Willy</td>
                                                    <td>Male</td>
                                                    <td>2</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('admin2/img/figure/student7.png')}}" alt="student"></td>
                                                    <td>Jessia Rose</td>
                                                    <td>Female</td>
                                                    <td>1</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('admin2/img/figure/student8.png')}}" alt="student"></td>
                                                    <td>Mark Willy</td>
                                                    <td>Male</td>
                                                    <td>2</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('admin2/img/figure/student9.png')}}" alt="student"></td>
                                                    <td>Jessia Rose</td>
                                                    <td>Female</td>
                                                    <td>1</td>
                                                    <td>A</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><img src="{{asset('admin2/img/figure/student10.png')}}" alt="student"></td>
                                                    <td>Mark Willy</td>
                                                    <td>Male</td>
                                                    <td>2</td>
                                                    <td>A</td>
