...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('admin2/img/favicon.png')}}">
    <!-- Normalize CSS -->
    <link rel="stylesheet" href="{{asset('admin2/css/normalize.css')}}">
    <!-- Main CSS -->
    <link rel="stylesheet" href="{{asset('admin2/css/main.css')}}">
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{asset('admin2/css/bootstrap.min.css')}}">
    <!-- Fontawesome CSS -->
    <link rel="stylesheet" href="{{asset('admin2/css/all.min.css')}}">
    <!-- Flaticon CSS -->
    <link rel="stylesheet" href="{{asset('admin2/fonts/flaticon.css')}}">
    <!-- Full Calender CSS -->
    <link rel="stylesheet" href="{{asset('admin2/css/fullcalendar.min.css')}}">
    <!-- Animate CSS -->
    <link rel="stylesheet" href="{{asset('admin2/css/animate.min.css')}}">
     <!-- Data Table CSS -->
    <link rel="stylesheet" href="{{asset('admin2/css/jquery.dataTables.min.css')}}">
    <!-- Custom CSS -->
    ...
    {{-- add student --}}
    <!-- Select 2 CSS -->
    <link rel="stylesheet" href="{{asset('admin2/css/select2.min.css')}}">
    <!-- Date Picker CSS -->
    <link rel="stylesheet" href="{{asset('admin2/css/datepicker.min.css')}}">
    <script src="{{asset('admin2/js/modernizr-3.6.0.min.js')}}"></script>
</head>
        ...
        <div class="navbar navbar-expand-md header-menu-one bg-light">
            <div class="nav-bar-header-one">
                <div class="header-logo">
                    <a href="{{ route('adminhome2') }}">
                        <img src="{{asset('admin2/img/logo.png')}}" alt="logo">
                    </a>
                </div>
            ...
            <div class="header-main-menu collapse navbar-collapse" id="mobile-navbar">
                ...
                <a href="{{ route('admin.home') }}">    <button style="margin-left: 10px; margin-top: 5px; border-radius: 40%;" type="button" class="btn btn-primary">new Version</button></a>
                <ul class="navbar-nav">
                    <li class="navbar-item dropdown header-admin">
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            aria-expanded="false">
                            <div class="admin-title">
                                <h5 class="item-title">{{Auth::user()->fname}} {{Auth::user()->lname}}</h5>
                                <span>Admin</span>
                            </div>
                            <div class="admin-img">
                                <img src="{{asset('admin/registerimage')}}/{{Auth::user()->image}}" height="30" width="30" alt="Admin">
                            </div>
                        </a>
                            ...
                            <div class="item-content">
                                <div class="media">
                                    <div class="item-img bg-skyblue author-online">
                                        <img src="{{asset('admin2/img/figure/student11.png')}}" alt="img">
                                    </div>
                                ...
                                <div class="media">
                                    <div class="item-img bg-yellow author-online">
                                        <img src="{{asset('admin2/img/figure/student12.png')}}" alt="img">
                                    </div>
                                    <div class="media-body space-sm">
                                        <div class="item-title">
                                            <a href="#">
                                ...
                                <div class="media">
                                    <div class="item-img bg-pink">
                                        <img src="{{asset('admin2/img/figure/student13.png')}}" alt="img">
                                    </div>
                                    <div class="media-body space-sm">
                                        <div class="item-title">
                                            <a href="#">
...
<!-- Page Area Start Here -->
        <div class="dashboard-page-one">
            ...
            <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
               <div class="mobile-sidebar-header d-md-none">
                    <div class="header-logo">
                        <a href="{{ route('adminhome2') }}"><img src="{{asset('admin2/img/logo1.png')}}" alt="logo"></a>
                    </div>
               </div>
                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="{{ route('adminhome2') }}" class="nav-link"><i class="fas fa-angle-right"></i>Admin</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('home2') }}" class="nav-link"><i
                                            class="fas fa-angle-right"></i>Students</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('parents.home') }}" class="nav-link"><i class="fas fa-angle-right"></i>Parents</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('teacher.home') }}" class="nav-link"><i
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="{{ route('allstudent') }}" class="nav-link"><i class="fas fa-angle-right"></i>All
                                        Students</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('studentdetails') }}" class="nav-link"><i
                                            class="fas fa-angle-right"></i>Student Details</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admissionform') }}" class="nav-link"><i
    ...
    <!-- Plugins js -->
    <script src="{{asset('admin2/js/plugins.js')}}"></script>
    <!-- Popper js -->
    <script src="{{asset('admin2/js/popper.min.js')}}"></script>
    <!-- Bootstrap js -->
    <script src="{{asset('admin2/js/bootstrap.min.js')}}"></script>
    <!-- Counterup Js -->
    <script src="{{asset('admin2/js/jquery.counterup.min.js')}}"></script>
    <!-- Moment Js -->
    <script src="{{asset('admin2/js/moment.min.js')}}"></script>
    <!-- Waypoints Js -->
    <script src="{{asset('admin2/js/jquery.waypoints.min.js')}}"></script>
    <!-- Scroll Up Js -->
    <script src="{{asset('admin2/js/jquery.scrollUp.min.js')}}"></script>
    <!-- Full Calender Js -->
    <script src="{{asset('admin2/js/fullcalendar.min.js')}}"></script>
    <!-- Chart Js -->
    <script src="{{asset('admin2/js/Chart.min.js')}}"></script>
    <!-- Custom Js -->
    <script src="{{asset('admin2/js/main.js')}}"></script>
     <!-- Data Table Js -->
    <script src="{{asset('admin2/js/jquery.dataTables.min.js')}}"></script>

    {{-- add student start --}}
     <!-- Date Picker Js -->
    <script src="{{asset('admin2/js/datepicker.min.js')}}"></script>
     <!-- Select 2 Js -->
    <script src="{{asset('admin2/js/select2.min.js')}}"></script>
